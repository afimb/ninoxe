class Chouette::Line < Chouette::TridentActiveRecord
  ...
  attr_accessible :transport_mode, :network_id, :company_id, :objectid, :object_version, :creation_time
  attr_accessible :creator_id, :name, :number, :published_name, :transport_mode_name, :registration_number, :comment
  attr_accessible :mobility_restricted_suitability, :int_user_needs
