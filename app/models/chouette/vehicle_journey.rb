class Chouette::VehicleJourney < Chouette::TridentActiveRecord
  ...
  attr_accessible :vehicle_journey_at_stops_attributes, :time_table_tokens, :time_tables, :mobility_restricted_suitability, :on_demand_transportation
  attr_reader :time_table_tokens

  def self.nullable_attributes
    [:transport_mode, :published_journey_name, :vehicle_type_identifier, :published_journey_identifier, :comment, :status_value, :mobility_restricted_suitability, :on_demand_transportation]
  end
